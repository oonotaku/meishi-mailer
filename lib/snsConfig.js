export const SNS_CONFIG = [
  ...
  { key: 'sns_x',         label: 'X',         category: 'personal', inputMode: 'username', baseUrl: 'https://x.com/',             icon: 'x',         color: '#e7e7e7', prefix: 'x.com/',            helpUrl: 'https://x.com/settings/account' },
  ...
  { key: 'sns_tiktok',    label: 'TikTok',    category: 'personal', inputMode: 'username', baseUrl: 'https://tiktok.com/@',       icon: 'tiktok',    color: '#e7e7e7', prefix: 'tiktok.com/@',      helpUrl: 'https://tiktok.com/' },
  { key: 'sns_threads',   label: 'Threads',   category: 'personal', inputMode: 'username', baseUrl: 'https://threads.net/@',      icon: 'threads',   color: '#e7e7e7', prefix: 'threads.net/@',     helpUrl: 'https://threads.net/' },
  ...
  { key: 'sns_github',    label: 'GitHub',    category: 'business', inputMode: 'username', baseUrl: 'https://github.com/',        icon: 'github',    color: '#e7e7e7', prefix: 'github.com/',       helpUrl: 'https://github.com/settings/profile' },
  { key: 'sns_vercel',    label: 'Vercel',    category: 'business', inputMode: 'username', baseUrl: 'https://vercel.com/',        icon: 'vercel',    color: '#e7e7e7', prefix: 'vercel.com/',       helpUrl: 'https://vercel.com/dashboard' },
