...
async function sendWithGmail(gmailRefreshToken, gmailEmail, { to, subject, text, html, cc, bcc }) {
 ...
 */
export async function sendEmail(profile, { to, subject, text, html, cc, bcc }) {
  ...
  if (provider === 'gmail') {
    ...
    await sendWithGmail(profile.gmail_refresh_token, profile.gmail_email, { to, subject, text, html, cc, bcc })
