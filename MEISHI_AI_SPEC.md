...
> 「名刺の裏面が、あなたのSNSハブになる。」
> 旧名: MeishiAI / meishi-mailer → **Koryu（交流）** にリブランディング（2026-05-09）
> ドメイン: koryu.app
...
### ポジショニング（2026-05-09 更新）
- **名刺をスキャン → ベントーグリッドプロフィール → SNSでつながる**、個人向けSNSハブツール
- B2Bチーム機能は削除。個人のネットワーキング体験に集中。
- Linktree / bento.me 的なプロフィールページ + 名刺スキャンAI + 出会い記録の三位一体。
- 日本発（Koryu = 交流）、グローバル展開を視野に。

### ターゲットユーザー
- 交流会・ビジネスイベントに積極的に参加する個人
- SNSリンクをスマートにまとめたい人
- 名刺交換後のフォローアップを効率化したい人

### 課金モデル（2026-05-09 確定）
- **Free**: プロフィール作成・名刺スキャン・SNSリンク管理・出会い記録（無料・無制限）
- **Pro ¥500/月 or ¥5,000/年**: ベントーグリッド編集・6種テーマ・QRコード発行
- Stripe live稼働中（月払い・年払いの2 Price ID）

---

## コア機能

### 1. 認証・プロフィール管理 ✅ 完了（※チーム機能は2026-05-09削除）
